...
### Changed
- Project metadata (`pyproject.toml`) normalized: version, description,
  and GenesisAeon-ecosystem dependency pins bumped to their released
  floors (`entropy-table>=2.0.0`, others `>=1.0.0`).
